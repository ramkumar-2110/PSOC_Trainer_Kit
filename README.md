...
[Provide feedback on this code example.](https://yourvoice.infineon.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
The following example clones the "[PSOC&trade; 4: Empty application template](https://github.com/Infineon/mtb-example-psoc4-empty-app)" application with the desired name "EmptyApplicationTemplate" configured for the [CY8CKIT-041S-MAX](https://www.infineon.com/CY8CKIT-041s-max) BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id CY8CKIT-041S-MAX --app-id mtb-example-psoc4-empty-app --user-app-name EmptyApplicationTemplate --target-dir "C:/mtb_projects"
   ```
...
Create a custom BSP for the board having any device, by following the steps given in the [ModusToolbox&trade; BSP Assistant user guide](https://www.infineon.com/ModusToolboxBSPAssistant). In this code example, BSP is created for the device "CY8C4149AZI-S598" on CY8CKIT-041S-MAX.
...
------- | ---------------------
 ...
 2.0.0   | Major update to support ModusToolbox&trade; software v2.2 and added support for new kits. This version is not backward compatible with ModusToolbox&trade; software v2.1.
 2.1.0   | Added support for new kits
 3.3.0   | Major update to support  ModusToolbox&trade; software v3.1. Minor readme update. Added support for new PSOC™ 4000T kit
 3.4.0   | Added support for CY8CPROTO-040T
 3.5.0   | Added support for KIT_PSOC4-HVMS-128K_LITE and KIT_PSOC4-HVMS-64K_LITE <br> Updated to support ModusToolbox&trade; software v3.2
 3.6.0   | Added support for CY8CPROTO-040T-MS and updated to support ModusToolbox&trade; v3.4.
 3.7.0   | Added support for CY8CPROTO-041TP and updated to support ModusToolbox&trade; v3.5.
 3.8.0   | Added support for KIT_PSOC4-HVMS-128K_LITE-02 and KIT_PSOC4-HVMS-64K_LITE-02
 3.9.0   | Added support for KIT_PSOC4-HVPA-144K_LITE
 3.10.0  | Added support for KIT_PSOC-HVPA-SPM1_LITE and updated to support ModusToolbox&trade; v3.7
 3.11.0  | Added support for CY8CPROTO-040T-AUTO and updated to support ModusToolbox&trade; v3.8
